  ...
  body: p => {
    ...
    function pins(def_neg, def_pos) {
      return `
        ...
        (pad 31 thru_hole circle (at 8.89 ${def_neg}5.08) (size 1.7526 1.7526) (drill 1.0922) (layers *.Cu *.SilkS *.Mask) ${p.P101.str})
        (pad 32 thru_hole circle (at 8.89 ${def_neg}2.54) (size 1.7526 1.7526) (drill 1.0922) (layers *.Cu *.SilkS *.Mask) ${p.P102.str})
        (pad 33 thru_hole circle (at 8.89 ${def_neg}0) (size 1.7526 1.7526) (drill 1.0922) (layers *.Cu *.SilkS *.Mask) ${p.P107.str})
        `
      }
